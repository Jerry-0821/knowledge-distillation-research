"""Download/check MNIST without training any model.

This script is a small data smoke test:
- It can download MNIST through TorchVision when ``--download`` is used.
...
from kd_research.data.mnist import create_mnist_loaders


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Check MNIST data loading.")
    parser.add_argument(
        "--data-dir",
        type=Path,
        default=Path("data"),
