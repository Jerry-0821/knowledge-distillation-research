"""Train the Fashion-MNIST teacher model with hard labels.

This script trains SimpleCNNTeacherModel with true Fashion-MNIST labels only.
The trained teacher will later be used as the source of soft targets, but this
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Train Fashion-MNIST hard-label teacher."
    )
...
def main() -> None:
    ...
    print("Fashion-MNIST hard-label teacher")
