"""Train the MNIST student with Knowledge Distillation.
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train MNIST student with KD.")
...
def main() -> None:
    ...
    print("MNIST distillation student")
